...
async function runTests() {
  ...
  fs.writeFileSync('benchmarks/postgres-results.json', JSON.stringify(output, null, 2));
  
  console.log(chalk.green('\n✅ PostgreSQL benchmarks complete!'));
  console.log(chalk.cyan(`   Results saved to: benchmarks/postgres-results.json\n`));
}
