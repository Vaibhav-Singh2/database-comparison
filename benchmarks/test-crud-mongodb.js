...
async function runTests() {
  ...
  console.log(
    chalk.blue.bold("║     MongoDB Performance Benchmarks                  ║")
  );
  console.log(
    chalk.blue.bold(
      "╚════════════════════════════════════════════════════════╝\n"
  ...
  for (let i = 0; i < 60; i++) {
    try {
      ...
      const testQuery = await axios.get(`${BASE_URL}/api/mongo/users/1`, {
        timeout: 2000,
      });
  ...
  console.log(
    chalk.cyan(`   Results saved to: benchmarks/mongodb-results.json\n`)
  );
}
